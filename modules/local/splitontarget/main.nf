...
process SPLITONTARGET {
    ...
    output:
    path './res_split_ontarget/ontarget*R1.fastq', emit: ontarget_read1
    path './res_split_ontarget/ontarget*R2.fastq', emit: ontarget_read2
    path './res_split_ontarget/offtarget*R1.fastq', emit: offtarget_read1
    path './res_split_ontarget/offtarget*R2.fastq', emit: offtarget_read2
